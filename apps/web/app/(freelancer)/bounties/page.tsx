    ...
    <main className="flex-1 w-full mx-auto px-6 py-8 space-y-8">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="p-6 rounded-2xl bg-surface border border-surface-border flex flex-col justify-between">
          <span className="text-xs font-mono text-muted uppercase">Open Jobs</span>
        ...
        <div className="p-6 rounded-2xl bg-surface border border-surface-border flex flex-col justify-between">
          ...
          <div className="text-2xl font-black text-foreground font-mono mt-2">
            {jobs.length > 0 ? formatBudget({ budget: totalValueLocked, tokenSymbol: "TOKENS" }) : "—"}
          </div>
          <div className="mt-4 pt-3 border-t border-surface-border text-xs text-[#22C55E]">Backed by on-chain escrow</div>
        </div>
        <div className="p-6 rounded-2xl bg-surface border border-surface-border flex flex-col justify-between">
          <span className="text-xs font-mono text-muted uppercase">Applications</span>
          <div className="text-2xl font-black text-foreground font-mono mt-2">
            {jobs.reduce((acc, j) => acc + (j._count?.applications || 0), 0)}
          </div>
          <div className="mt-4 pt-3 border-t border-surface-border text-xs text-muted">Submitted by freelancers</div>
        </div>
      </section>
